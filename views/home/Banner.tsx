	...
	return (
		<>
			...
			<div className='relative sm:pt-10 sm:border-r sm:border-l'>
				<div className='absolute -top-[26px] sm:-top-[31px] left-[200px] sm:left-[35%] md:left-[35%] lg:left-[39%] xl:-top-[38px] xl:left-[42%] bg-background rounded-full border 2xl:px-[34px] px-[24px] py-[14px] 2xl:py-[20px] font-medium text-sm md:text-lg max-w-max'><p>Technologies  we work on</p></div>
